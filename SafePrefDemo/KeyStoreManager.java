...
public class KeyStoreManager {
    ...
    public void init() {
        L.d("init");
        String encryptAESKey = PrefUtil.getAESKey();
        String iv = PrefUtil.getIV();
        if (encryptAESKey == null || iv == null) {
            L.d("gen");
            try {
    ...
    private void genKeyStoreKey() throws Exception {
    ...
    private void genAESKey() throws Exception {
        ...
        PrefUtil.setAESKey(encryptAESKey);
    }
